...
The current art is deterministic placeholder drawing inside Godot: survivor, raft, wood, rope, shore animals, alligators, and trees now have readable silhouettes instead of plain debug rectangles.
