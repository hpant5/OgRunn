...
- Keep constants centralized in `unity/Runn/Assets/Scripts/Systems/GameConstants.cs`.
- Keep level data in text files under `unity/Runn/Assets/Levels/Resources`.
